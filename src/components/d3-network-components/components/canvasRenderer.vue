...
export default {
    ...
    methods: {
         ...
         *
         * @return {{r: number, g: number, b: number, rgb: string}}
         */
        randomColor() {
         ...
         *
         * @param node
         * @return {{_cssClass: string, _svgElement: string, fillStyle: string, fontFamily: string}|labels|{_cssClass, _svgElement, fillStyle, fontFamily}}
         */
        labelStyle(node) {
